...
/* harmony export */   __debug: () => (/* binding */ debugApis),
/* harmony export */   __internal: () => (/* binding */ sharedWithCli),
/* harmony export */   check: () => (/* binding */ check),
/* harmony export */   clearConfigCache: () => (/* binding */ clearCache3),
/* harmony export */   "default": () => (/* binding */ src_default),
/* harmony export */   doc: () => (/* reexport module object */ _doc_mjs__WEBPACK_IMPORTED_MODULE_3__),
/* harmony export */   format: () => (/* binding */ format2),
/* harmony export */   formatWithCursor: () => (/* binding */ formatWithCursor2),
/* harmony export */   getFileInfo: () => (/* binding */ getFileInfo2),
/* harmony export */   getSupportInfo: () => (/* binding */ getSupportInfo2),
/* harmony export */   resolveConfig: () => (/* binding */ resolveConfig),
/* harmony export */   resolveConfigFile: () => (/* binding */ resolveConfigFile),
/* harmony export */   util: () => (/* binding */ public_exports),
/* harmony export */   version: () => (/* binding */ version_evaluate_default)
/* harmony export */ });
/* harmony import */ var module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(481);
/* harmony import */ var url__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(491);
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(457);
/* harmony import */ var process__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(540);
/* harmony import */ var os__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(500);
/* harmony import */ var tty__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(79);
/* harmony import */ var fs_promises__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(541);
/* harmony import */ var assert__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(543);
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(482);
/* harmony import */ var v8__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(544);
/* harmony import */ var util__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(80);
/* harmony import */ var _doc_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(539);



const require = (0,module__WEBPACK_IMPORTED_MODULE_0__.createRequire)("file:///C:/Users/Tariq%20Mehmood/.1.All%20Done%20Projects/IDE%20Extensions/syntaxility-code-formatter/node_modules/prettier/index.mjs");
const __filename = (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)("file:///C:/Users/Tariq%20Mehmood/.1.All%20Done%20Projects/IDE%20Extensions/syntaxility-code-formatter/node_modules/prettier/index.mjs");
...
__export(index_exports, {
  ...
  doc: () => _doc_mjs__WEBPACK_IMPORTED_MODULE_3__,
  format: () => format2,
...
function hasFlag(flag, argv = globalThis.Deno ? globalThis.Deno.args : process__WEBPACK_IMPORTED_MODULE_4__.argv) {
  const prefix = flag.startsWith("-") ? "" : flag.length === 1 ? "-" : "--";
  const position = argv.indexOf(prefix + flag);
  const terminatorPosition = argv.indexOf("--");
  return position !== -1 && (terminatorPosition === -1 || position < terminatorPosition);
}
var { env } = process__WEBPACK_IMPORTED_MODULE_4__;
var flagForceColor;
...
function _supportsColor(haveStream, { streamIsTTY, sniffFlags = true } = {}) {
  ...
  if (process__WEBPACK_IMPORTED_MODULE_4__.platform === "win32") {
    const osRelease = os__WEBPACK_IMPORTED_MODULE_5__.release().split(".");
...
var supportsColor = {
  stdout: createSupportsColor({ isTTY: tty__WEBPACK_IMPORTED_MODULE_6__.isatty(1) }),
  stderr: createSupportsColor({ isTTY: tty__WEBPACK_IMPORTED_MODULE_6__.isatty(2) })
};
...
var toPath = (urlOrPath) => isUrl(urlOrPath) ? (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(urlOrPath) : urlOrPath;
...
async function isDirectory(directory, options8) {
  ...
  let stats;
  try {
    stats = await (allowSymlinks ? fs_promises__WEBPACK_IMPORTED_MODULE_7__.stat : fs_promises__WEBPACK_IMPORTED_MODULE_7__.lstat)(toPath(directory));
  } catch {
    return false;
  }
...
var toAbsolutePath = (value) => path__WEBPACK_IMPORTED_MODULE_2__.resolve(toPath(value));
function* iterateDirectoryUp(from, to) {
  from = toAbsolutePath(from);
  const { root: root2 } = path__WEBPACK_IMPORTED_MODULE_2__.parse(from);
  to = to ? toAbsolutePath(to) : root2;
  if (from !== to && !from.startsWith(to)) {
    return;
  }
  for (let directory = from; directory !== to; directory = path__WEBPACK_IMPORTED_MODULE_2__.dirname(directory)) {
    yield directory;
  }
  yield to;
}
...
searchInDirectory_fn = async function(directory, shouldCache) {
  ...
  for (const name of __privateGet(this, _names)) {
    const fileOrDirectory = path__WEBPACK_IMPORTED_MODULE_2__.join(directory, name);
...
async function findProjectRoot(startDirectory, options8) {
  ...
  return mark ? path__WEBPACK_IMPORTED_MODULE_2__.dirname(mark) : void 0;
}
...
async function loadEditorconfigInternal(file, { shouldCache }) {
  const directory = path__WEBPACK_IMPORTED_MODULE_2__.dirname(file);
...
function loadEditorconfig(file, { shouldCache }) {
  file = path__WEBPACK_IMPORTED_MODULE_2__.resolve(file);
...
function writeFormattedFile(file, data) {
  return fs_promises__WEBPACK_IMPORTED_MODULE_7__.writeFile(file, data);
}
var mockable = {
...
async function isFile(file, options8) {
  ...
  let stats;
  try {
    stats = await (allowSymlinks ? fs_promises__WEBPACK_IMPORTED_MODULE_7__.stat : fs_promises__WEBPACK_IMPORTED_MODULE_7__.lstat)(toPath(file));
  } catch {
    return false;
  }
  return stats.isFile();
...
async function readFile(file) {
  ...
  try {
    return await fs_promises__WEBPACK_IMPORTED_MODULE_7__.readFile(file, "utf8");
  } catch (error) {
...
async function importModuleDefault(file) {
  const module = await __webpack_require__(542)((0,url__WEBPACK_IMPORTED_MODULE_1__.pathToFileURL)(file).href);
...
codes.ERR_INVALID_ARG_TYPE = createError(
  ...
  (name, expected, actual) => {
    assert__WEBPACK_IMPORTED_MODULE_8__(typeof name === "string", "'name' must be a string");
    ...
    for (const value of expected) {
      assert__WEBPACK_IMPORTED_MODULE_8__(
        typeof value === "string",
...
codes.ERR_INVALID_PACKAGE_TARGET = createError(
  ...
  (packagePath, key2, target, isImport = false, base = void 0) => {
    ...
    if (key2 === ".") {
      assert__WEBPACK_IMPORTED_MODULE_8__(isImport === false);
...
codes.ERR_INVALID_ARG_VALUE = createError(
  ...
  (name, value, reason = "is invalid") => {
    let inspected = (0,util__WEBPACK_IMPORTED_MODULE_11__.inspect)(value);
...
function isErrorStackTraceLimitWritable() {
  try {
    if (v8__WEBPACK_IMPORTED_MODULE_10__.startupSnapshot.isBuildingSnapshot()) {
      return false;
    }
  } catch {
  }
...
function getMessage(key2, parameters, self) {
  ...
  assert__WEBPACK_IMPORTED_MODULE_8__(message !== void 0, "expected `message` to be found");
  ...
  return Reflect.apply(util__WEBPACK_IMPORTED_MODULE_11__.format, null, parameters);
}
function determineSpecificType(value) {
  ...
  if (typeof value === "object") {
    ...
    return `${(0,util__WEBPACK_IMPORTED_MODULE_11__.inspect)(value, { depth: -1 })}`;
  }
  let inspected = (0,util__WEBPACK_IMPORTED_MODULE_11__.inspect)(value, { colors: false });
...
function read2(jsonPath, { base, specifier }) {
  ...
  let string;
  try {
    string = fs__WEBPACK_IMPORTED_MODULE_9__.readFileSync(path__WEBPACK_IMPORTED_MODULE_2__.toNamespacedPath(jsonPath), "utf8");
  } catch (error) {
    const exception2 = (
      /** @type {ErrnoException} */
      error
  ...
  if (string !== void 0) {
    ...
    try {
      ...
      const error = new ERR_INVALID_PACKAGE_CONFIG(
        jsonPath,
        (base ? `"${specifier}" from ` : "") + (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(base || specifier),
        cause.message
      );
      error.cause = cause;
      throw error;
...
function getPackageScopeConfig(resolved) {
  ...
  while (true) {
    ...
    const packageConfig = read2((0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(packageJSONUrl), {
      specifier: resolved
    });
  ...
  const packageJSONPath = (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(packageJSONUrl);
  return {
...
function getFileProtocolModuleFormat(url2, _context, ignoreErrors) {
  ...
  const filepath = (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(url2);
...
function emitInvalidSegmentDeprecation(target, request, match, packageJsonUrl, internal, base, isTarget) {
  if (process__WEBPACK_IMPORTED_MODULE_4__.noDeprecation) {
    return;
  }
  const pjsonPath = (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(packageJsonUrl);
  const double = doubleSlashRegEx.exec(isTarget ? target : request) !== null;
  process__WEBPACK_IMPORTED_MODULE_4__.emitWarning(
    `Use of deprecated ${double ? "double slash" : "leading or trailing slash matching"} resolving "${target}" for module request "${request}" ${request === match ? "" : `matched to "${match}" `}in the "${internal ? "imports" : "exports"}" field module resolution of the package at ${pjsonPath}${base ? ` imported from ${(0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(base)}` : ""}.`,
    "DeprecationWarning",
    "DEP0166"
  );
}
function emitLegacyIndexDeprecation(url2, packageJsonUrl, base, main) {
  ...
  const urlPath = (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(url2.href);
  const packagePath = (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(new url__WEBPACK_IMPORTED_MODULE_1__.URL(".", packageJsonUrl));
  const basePath = (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(base);
  if (!main) {
    process__WEBPACK_IMPORTED_MODULE_4__.emitWarning(
...
Default "index" lookups for the main are deprecated for ES modules.`,
  ...
  } else if (path__WEBPACK_IMPORTED_MODULE_2__.resolve(packagePath, main) !== urlPath) {
    process__WEBPACK_IMPORTED_MODULE_4__.emitWarning(
...
function tryStatSync(path13) {
  try {
    return (0,fs__WEBPACK_IMPORTED_MODULE_9__.statSync)(path13);
  } catch {
  }
}
function fileExists(url2) {
  const stats = (0,fs__WEBPACK_IMPORTED_MODULE_9__.statSync)(url2, { throwIfNoEntry: false });
...
function legacyMainResolve(packageJsonUrl, packageConfig, base) {
  ...
  if (packageConfig.main !== void 0) {
    guess = new url__WEBPACK_IMPORTED_MODULE_1__.URL(packageConfig.main, packageJsonUrl);
    ...
    while (++i2 < tries2.length) {
      guess = new url__WEBPACK_IMPORTED_MODULE_1__.URL(tries2[i2], packageJsonUrl);
  ...
  while (++i < tries.length) {
    guess = new url__WEBPACK_IMPORTED_MODULE_1__.URL(tries[i], packageJsonUrl);
    if (fileExists(guess)) break;
    guess = void 0;
  }
  if (guess) {
  ...
  throw new ERR_MODULE_NOT_FOUND(
    (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(new url__WEBPACK_IMPORTED_MODULE_1__.URL(".", packageJsonUrl)),
    (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(base)
  );
}
function finalizeResolution(resolved, base, preserveSymlinks) {
  ...
  let filePath;
  try {
    filePath = (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(resolved);
  } catch (error) {
    const cause = (
      /** @type {ErrnoException} */
      error
  ...
  if (stats && stats.isDirectory()) {
    const error = new ERR_UNSUPPORTED_DIR_IMPORT(filePath, (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(base));
  ...
  if (!stats || !stats.isFile()) {
    const error = new ERR_MODULE_NOT_FOUND(
      ...
      base && (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(base),
      true
    );
    error.url = String(resolved);
    throw error;
  ...
  if (!preserveSymlinks) {
    const real = (0,fs__WEBPACK_IMPORTED_MODULE_9__.realpathSync)(filePath);
    const { search, hash } = resolved;
    resolved = (0,url__WEBPACK_IMPORTED_MODULE_1__.pathToFileURL)(real + (filePath.endsWith(path__WEBPACK_IMPORTED_MODULE_2__.sep) ? "/" : ""));
...
function importNotDefined(specifier, packageJsonUrl, base) {
  return new ERR_PACKAGE_IMPORT_NOT_DEFINED(
    specifier,
    packageJsonUrl && (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(new url__WEBPACK_IMPORTED_MODULE_1__.URL(".", packageJsonUrl)),
    (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(base)
  );
}
...
function throwInvalidSubpath(request, match, packageJsonUrl, internal, base) {
  const reason = `request is not a valid match in pattern "${match}" for the "${internal ? "imports" : "exports"}" resolution of ${(0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(packageJsonUrl)}`;
  throw new ERR_INVALID_MODULE_SPECIFIER(
    request,
    reason,
    base && (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(base)
...
function resolvePackageTargetString(target, subpath, match, packageJsonUrl, base, pattern, internal, isPathMap, conditions) {
  ...
  if (!target.startsWith("./")) {
    if (internal && !target.startsWith("../") && !target.startsWith("/")) {
      let isURL2 = false;
      try {
        new url__WEBPACK_IMPORTED_MODULE_1__.URL(target);
        isURL2 = true;
      } catch {
      }
      if (!isURL2) {
  ...
  const resolved = new url__WEBPACK_IMPORTED_MODULE_1__.URL(target, packageJsonUrl);
  const resolvedPath = resolved.pathname;
  const packagePath = new url__WEBPACK_IMPORTED_MODULE_1__.URL(".", packageJsonUrl).pathname;
  ...
  if (pattern) {
    return new url__WEBPACK_IMPORTED_MODULE_1__.URL(
  ...
  return new url__WEBPACK_IMPORTED_MODULE_1__.URL(subpath, resolved);
}
    ...
    while (++i < keys.length) {
      ...
      if (isArrayIndex(key2)) {
        throw new ERR_INVALID_PACKAGE_CONFIG2(
          (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(packageJsonUrl),
          base,
...
function emitTrailingSlashPatternDeprecation(match, pjsonUrl, base) {
  ...
  const pjsonPath = (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(pjsonUrl);
  if (emittedPackageWarnings.has(pjsonPath + "|" + match)) return;
  emittedPackageWarnings.add(pjsonPath + "|" + match);
  process__WEBPACK_IMPORTED_MODULE_4__.emitWarning(
    `Use of deprecated trailing slash pattern mapping "${match}" in the "exports" field module resolution of the package at ${pjsonPath}${base ? ` imported from ${(0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(base)}` : ""}. Mapping specifiers ending in "/" is no longer supported.`,
    "DeprecationWarning",
    "DEP0155"
  );
}
...
function packageImportsResolve(name, base, conditions) {
  if (name === "#" || name.startsWith("#/") || name.endsWith("/")) {
    ...
    throw new ERR_INVALID_MODULE_SPECIFIER(name, reason, (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(base));
  }
  let packageJsonUrl;
  const packageConfig = getPackageScopeConfig(base);
  if (packageConfig.exists) {
    packageJsonUrl = (0,url__WEBPACK_IMPORTED_MODULE_1__.pathToFileURL)(packageConfig.pjsonPath);
...
function packageResolve(specifier, base, conditions) {
  if (module__WEBPACK_IMPORTED_MODULE_0__.builtinModules.includes(specifier)) {
    return new url__WEBPACK_IMPORTED_MODULE_1__.URL("node:" + specifier);
  }
  ...
  const packageConfig = getPackageScopeConfig(base);
  if (packageConfig.exists) {
    const packageJsonUrl2 = (0,url__WEBPACK_IMPORTED_MODULE_1__.pathToFileURL)(packageConfig.pjsonPath);
  ...
  let packageJsonUrl = new url__WEBPACK_IMPORTED_MODULE_1__.URL(
    "./node_modules/" + packageName + "/package.json",
    base
  );
  let packageJsonPath = (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(packageJsonUrl);
  let lastPath;
  do {
    const stat = tryStatSync(packageJsonPath.slice(0, -13));
    if (!stat || !stat.isDirectory()) {
      lastPath = packageJsonPath;
      packageJsonUrl = new url__WEBPACK_IMPORTED_MODULE_1__.URL(
        (isScoped ? "../../../../node_modules/" : "../../../node_modules/") + packageName + "/package.json",
        packageJsonUrl
      );
      packageJsonPath = (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(packageJsonUrl);
      continue;
    }
    ...
    return new url__WEBPACK_IMPORTED_MODULE_1__.URL(packageSubpath, packageJsonUrl);
  } while (packageJsonPath.length !== lastPath.length);
  throw new ERR_MODULE_NOT_FOUND(packageName, (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(base), false);
}
...
function moduleResolve(specifier, base, conditions, preserveSymlinks) {
  ...
  if (shouldBeTreatedAsRelativeOrAbsolutePath(specifier)) {
    try {
      resolved = new url__WEBPACK_IMPORTED_MODULE_1__.URL(specifier, base);
    } catch (error_) {
    ...
    try {
      resolved = new url__WEBPACK_IMPORTED_MODULE_1__.URL(specifier);
    } catch (error_) {
      if (isRemote && !module__WEBPACK_IMPORTED_MODULE_0__.builtinModules.includes(specifier)) {
        const error = new ERR_UNSUPPORTED_RESOLVE_REQUEST(specifier, base);
        error.cause = error_;
        throw error;
      }
  ...
  assert__WEBPACK_IMPORTED_MODULE_8__(resolved !== void 0, "expected to be defined");
...
function defaultResolve(specifier, context = {}) {
  ...
  assert__WEBPACK_IMPORTED_MODULE_8__(parentURL !== void 0, "expected `parentURL` to be defined");
  throwIfInvalidParentURL(parentURL);
  let parsedParentURL;
  if (parentURL) {
    try {
      parsedParentURL = new url__WEBPACK_IMPORTED_MODULE_1__.URL(parentURL);
    } catch {
    }
  }
  let parsed;
  let protocol;
  try {
    parsed = shouldBeTreatedAsRelativeOrAbsolutePath(specifier) ? new url__WEBPACK_IMPORTED_MODULE_1__.URL(specifier, parsedParentURL) : new url__WEBPACK_IMPORTED_MODULE_1__.URL(specifier);
  ...
  const url2 = moduleResolve(specifier, new url__WEBPACK_IMPORTED_MODULE_1__.URL(parentURL), conditions, false);
  return {
...
function importFromFile(specifier, parent) {
  const url2 = resolve2(specifier, (0,url__WEBPACK_IMPORTED_MODULE_1__.pathToFileURL)(parent).href);
  return __webpack_require__(542)(url2);
}
...
function requireFromFile(id, parent) {
  const require2 = (0,module__WEBPACK_IMPORTED_MODULE_0__.createRequire)(parent);
  return require2(id);
}
...
async function loadConfig(configFile) {
  const { base: fileName, ext: extension } = path__WEBPACK_IMPORTED_MODULE_2__.parse(configFile);
...
function loadPrettierConfig(configFile, { shouldCache }) {
  configFile = path__WEBPACK_IMPORTED_MODULE_2__.resolve(configFile);
...
function getSearchFunction(stopDirectory) {
  stopDirectory = stopDirectory ? path__WEBPACK_IMPORTED_MODULE_2__.resolve(stopDirectory) : void 0;
...
function searchPrettierConfig(startDirectory, options8 = {}) {
  startDirectory = startDirectory ? path__WEBPACK_IMPORTED_MODULE_2__.resolve(startDirectory) : process.cwd();
...
async function loadPrettierConfig2(file, options8) {
  ...
  if (!configFile) {
    const directory = file ? path__WEBPACK_IMPORTED_MODULE_2__.dirname(path__WEBPACK_IMPORTED_MODULE_2__.resolve(file)) : void 0;
...
async function resolveConfig(fileUrlOrPath, options8) {
  ...
  if (Array.isArray(merged.plugins)) {
    merged.plugins = merged.plugins.map(
      (value) => typeof value === "string" && value.startsWith(".") ? path__WEBPACK_IMPORTED_MODULE_2__.resolve(path__WEBPACK_IMPORTED_MODULE_2__.dirname(result.configFile), value) : value
    );
  }
  return merged;
}
async function resolveConfigFile(fileUrlOrPath) {
  const directory = fileUrlOrPath ? path__WEBPACK_IMPORTED_MODULE_2__.dirname(path__WEBPACK_IMPORTED_MODULE_2__.resolve(toPath(fileUrlOrPath))) : void 0;
...
function mergeOverrides(configResult, filePath) {
  ...
  if (filePath && overrides) {
    const relativeFilePath = path__WEBPACK_IMPORTED_MODULE_2__.relative(path__WEBPACK_IMPORTED_MODULE_2__.dirname(configFile), filePath);
...
var slash = path__WEBPACK_IMPORTED_MODULE_2__.sep === "\\" ? (filePath) => string_replace_all_default(
  /* isOptionalObject */
  false,
  filePath,
  "\\",
...
function getRelativePath(file, ignoreFile) {
  ...
  const filePath = isUrl(file) ? url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath(file) : path__WEBPACK_IMPORTED_MODULE_2__.resolve(file);
  return path__WEBPACK_IMPORTED_MODULE_2__.relative(
    // If there's an ignore-path set, the filename must be relative to the
    // ignore path, not the current working directory.
    ignoreFilePath ? path__WEBPACK_IMPORTED_MODULE_2__.dirname(ignoreFilePath) : process.cwd(),
    filePath
  );
}
...
function getInterpreter(file) {
  let fd;
  try {
    fd = fs__WEBPACK_IMPORTED_MODULE_9__.openSync(file, "r");
  } catch {
    return;
  }
  try {
    ...
    try {
      fs__WEBPACK_IMPORTED_MODULE_9__.closeSync(fd);
    } catch {
    }
  }
}
...
function breakTies(tiesToBreak, options8) {
  ...
  for (indexOfFirstLeadingComment = tieCount; indexOfFirstLeadingComment > 0; --indexOfFirstLeadingComment) {
    ...
    assert__WEBPACK_IMPORTED_MODULE_8__.strictEqual(currentCommentPrecedingNode, precedingNode);
    assert__WEBPACK_IMPORTED_MODULE_8__.strictEqual(currentCommentFollowingNode, followingNode);
...
function calculateRange(text, opts, ast) {
  ...
  assert__WEBPACK_IMPORTED_MODULE_8__.ok(end > start);
...
var { parsers, printers } = createParsersAndPrinters([
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 6).then(__webpack_require__.bind(__webpack_require__, 560)),
    parsers: ["acorn", "espree"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 7).then(__webpack_require__.bind(__webpack_require__, 561)),
    parsers: [
      "__ng_action",
      "__ng_binding",
      "__ng_interpolation",
  ...
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 8).then(__webpack_require__.bind(__webpack_require__, 562)),
    parsers: [
      "babel",
      "babel-flow",
      "babel-ts",
  ...
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 9).then(__webpack_require__.bind(__webpack_require__, 563)),
    printers: ["estree", "estree-json"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 10).then(__webpack_require__.bind(__webpack_require__, 564)),
    parsers: ["flow"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 11).then(__webpack_require__.bind(__webpack_require__, 565)),
    parsers: ["glimmer"],
    printers: ["glimmer"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 12).then(__webpack_require__.bind(__webpack_require__, 566)),
    parsers: ["graphql"],
    printers: ["graphql"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 13).then(__webpack_require__.bind(__webpack_require__, 567)),
    parsers: ["html", "angular", "vue", "lwc"],
    printers: ["html"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 14).then(__webpack_require__.bind(__webpack_require__, 568)),
    parsers: ["markdown", "mdx", "remark"],
    printers: ["mdast"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 15).then(__webpack_require__.bind(__webpack_require__, 569)),
    parsers: ["meriyah"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 16).then(__webpack_require__.bind(__webpack_require__, 570)),
    parsers: ["css", "less", "scss"],
    printers: ["postcss"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 17).then(__webpack_require__.bind(__webpack_require__, 571)),
    parsers: ["typescript"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 18).then(__webpack_require__.bind(__webpack_require__, 572)),
    parsers: ["yaml"],
    printers: ["yaml"]
  }
]);
...
function importFromDirectory(specifier, directory) {
  return import_from_file_default(specifier, path__WEBPACK_IMPORTED_MODULE_2__.join(directory, "noop.js"));
}
...
async function importPlugin(name, cwd) {
  if (path__WEBPACK_IMPORTED_MODULE_2__.isAbsolute(name)) {
    return __webpack_require__(542)((0,url__WEBPACK_IMPORTED_MODULE_1__.pathToFileURL)(name).href);
  }
  try {
    return await __webpack_require__(542)((0,url__WEBPACK_IMPORTED_MODULE_1__.pathToFileURL)(path__WEBPACK_IMPORTED_MODULE_2__.resolve(name)).href);
  } catch {
